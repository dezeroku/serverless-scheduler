...
export function getToken() {
  if (isDev()) {
    let devToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0QGV4YW1wbGUudXJsIiwibmFtZSI6InRlc3R1c2VyIiwiaWF0IjoxNTE2MjM5MDIyfQ.FqZJO19KHW7EQoAf8LIVRu31nruBFLm4LrUBBSs_TQE";
