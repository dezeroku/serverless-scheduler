...
function EditModal(props: EditModalProps) {
        ...
        <Modal.Body hidden={loading}>
          <Form onSubmit={handleTaskLocal}>
            ...
            <Form.Group controlId="sleep_time">
              <Form.Label>
                How often (in minutes) should the page be checked
              </Form.Label>
            ...
            <Form.Group controlId="make_screenshots">
              <Form.Check
                type="checkbox"
                label="Make screenshots"
                defaultChecked={temp.make_screenshots}
              />
              <Form.Label>
                When checked, screenshots of changes will be attached to
                notification
              </Form.Label>
            </Form.Group>
            ...
            {props.editMode ? (
              <Button
                type="button"
                variant="danger"
                onClick={() => handleDeleteLocal(temp.job_id)}
  ...
  return <div>{content(props.item)}</div>;
}
